            ...
            <div className="container max-w-5xl mx-auto px-4 mt-8 mb-12">
                ...
                <div className="bg-white rounded-[24px] shadow-xl shadow-slate-200/50 border border-slate-200 overflow-hidden">
                    ...
                    <div className="flex flex-col bg-slate-50/30">
                        ...
                        <div className="p-6 md:p-8 bg-white border-b border-slate-100">
                            ...
                            <div className="space-y-4">
                                {order.items.map((item, idx) => (
                                    <div key={item.productId} className={`flex items-center gap-4 pb-4 ${idx !== order.items.length - 1 ? 'border-b border-slate-100' : ''}`}>
                        ...
                        {/* 4. Review Section (Only Customer) */}
                        {isCustomer && (
                            <div className="p-6 md:p-8 border-t border-slate-100 bg-white">
                                ...
                                {orderReview ? (
                                    ...
                                    <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                                        ...
                                        <button onClick={handleSubmitOrderReview} className="bg-orange-500 text-white font-bold py-2.5 px-6 rounded-lg hover:bg-orange-600 transition">Gửi đánh giá</button>
                                    </div>
                                ) : (
